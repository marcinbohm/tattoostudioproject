...
<head>
    ...
    <title>Dominci Tattoo</title>
    <link rel="stylesheet" href="strona_style3.css">
    <link rel="stylesheet" href="strona_style2.css">
    <link rel="stylesheet" href="bootstrap.min.css">
    <link rel="stylesheet" href="strona_style.css">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans&display=swap" rel="stylesheet"><link href="https://fonts.googleapis.com/css?family=Courgette|Ibarra+Real+Nova|Indie+Flower&display=swap" rel="stylesheet">
...
<body id="contactbody">
   <div class="loader">
        <div class="logoloader">
            <div id="opacanim">
            <img src="Logo2.gif" alt="" width="340" height="380">
            <div id="pageloading">Ładowanie strony...</div>
            </div>
        </div>
    </div>
    <main>
        <header>
            <nav class="navbar navbar-dark col-12 navbar-expand-lg" id="navigation_bar">
                <a class="navbar-brand" href="index.html"><img src="Logo.gif" alt="" width="65" height="70" class="d-inlineblock mr-1 align-bottom" id="logo"></a>
                <button style="width=30px" class="navbar-toggler my-button" type="button" data-toggle="collapse" data-target="#mainmenu" aria-controls="mainmenu" aria-expanded="false" aria-label="Przelacznik nawigacji">
                    <div class="animated-icon"><span></span><span></span><span></span><span></span></div>
                </button>
                <div class="collapse navbar-collapse" id="mainmenu">
                    <ul class="navbar-nav navbar-left mx-auto">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" aria-expanded="false" href="#" data-toggle="dropdown" role="button" id="submenu" aria-haspopup="true">Usługi</a>
                            <div class="dropdown-menu" aria-labelledby="submenu">
                                <a class="dropdown-item" href="#">Tatuaż</a>
                                <a class="dropdown-item" href="#"> Piercing</a>
                                <a class="dropdown-item" href="#">Laser</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" aria-expanded="false" href="#" data-toggle="dropdown" role="button" id="submenu2" aria-haspopup="true">Galeria</a>
                            <div class="dropdown-menu" aria-labelledby="submenu2">
                                <a class="dropdown-item" href="coltattoos.html">Tatuaże</a>
                                <a class="dropdown-item" href="piercing.html">Piercing</a>
                                <a class="dropdown-item" href="laser.html">Laser</a>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="opinie.php">Aktualności</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav navbar-right mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="files_to_download.html">Pliki do pobrania</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <article>
            <section>
                <div class="col-12" id="navbarodstcol"></div>
            </section>
            <section>
                <div id="sectiondiv" class="col-12" style="height: 800px">
                    <div class="col-12 col-md-6" id="contact">
                        <div class="col-12">
                            <div id="emailandoth" class="col-12 col-md-6">
                                <ul class="list-unstyled mb-0">
                                    <li>
                                        <p style="font-size: 23px">Studio tatuażu i piercingu: </p>
                                        <br>
                                        <br>
                                    </li>
                                    <li>
                                        <p style="font-size: 23px">Dominci Tattoo</p>
                                        <p style="font-size: 23px">ul. Czwartaków 18</p>
                                        <p style="font-size: 23px"> 44-100 Gliwice</p>
                                    </li>
                                        <br>
                                    <li>
                                        <p style="font-size: 23px">tel: +48 534-188-575</p>
                                    </li>

                                    <li>
                                        <br>
                                        <p style="font-size: 15px;">e-mail:</p>
                                        <p style="font-size: 20px">domincitattoo@gmail.com</p>
                                    </li>
                                </ul>
                            </div>
                            <div id="write_logo" class="col-md-6">
                                <img src="Logo2.gif" alt="">
                            </div>
                        </div>
                        <div class="col-12" id="contactinside">
                        <p style="font-size: 25px; margin-bottom: 20px">Napisz wiadomość:</p>
                            <div class="row">
                                <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="md-form mb-0">
                                                    ...
                                                    <label for="name" class="" style="font-size: 20px">Twoje imię i nazwisko</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="md-form mb-0">
                                                    <input type="text" id="email" name="email" class="form-control">
                                                    <label for="email" class="" style="font-size: 20px">Email</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="md-form mb-0">
                                                    ...
                                                    <label for="subject" class="" style="font-size: 20px">Temat</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="md-form">
                                                    ...
                                                    <label for="message" style="font-size: 20px">Treść</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="messages">
                                           <?php
                                                if(isset($_POST['name'])){
                                                    ...
                                                    $content="From: $name \n Email: $email \n Message: $message";
                                                    $recipient = "marcin.bohm30@gmail.com";
                                                    $mailheader = "From: $email \r\n";

                                                }
                                                      
                                                if($message != '' && $subject != '' && filter_var($email, FILTER_VALIDATE_EMAIL) && $name != ''){
                                ...
                                <div style="margin-top: 20px">
                                    <span>Klikając przycisk "wyślij wiadomość", wyrażasz zgodę na przetwarzanie swoich danych osobowych w celu odpowiedzi na twoje pytanie.</span>
                                </div>
                                <div class="container">
                                    <div class="center">
                                        <button onclick="document.getElementById('contact-form').submit()"><svg width="240px" height="60px" viewBox="0 0 240 60">
                                            <polyline points="239,1 240,59 1,59 1,1 239,1" class="bg-line" />
                                            <polyline points="239,1 240,59 1,59 1,1 239,1" class="hl-line" />
                                            </svg>
                        ...
                        <div class="col-12 col-md-6 " id="googlemap">
                            <div class="col-12">
                               ...
                               <br>
                               <br>
                                <div id="find-us">Znajdziesz nas tutaj:</div>
                            </div>
                            <div class="col-12" id="google-first">
                                <div id="map"><iframe id="gglmp" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d691.542136466509!2d18.645172889138863!3d50.30040781156774!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47113061d979ac93%3A0x2efef824ce12ce3f!2sDominci%20Tattoo!5e0!3m2!1sen!2spl!4v1584835018859!5m2!1sen!2spl" width="600" height="750" frameborder="0" style="border:0;" allowfullscreen="true" aria-hidden="false" tabindex="0"></iframe></div>
                            </div>
                        </div> 
                </div>
            </section>
            <footer class="col-12">
                <div class="col-12" id="portals">
                    <div class="col-lg-4 portals-columns" id="left-p"><p>Godziny otwarcia</p>
                        <div class="col-12" id="hoursf">
                            <div class="col-6 hours justify-content-center">
                                <div class="hoursopen">Poniedziałek 9:00 - 15:30</div>
                                <div class="hoursopen">Wtorek 9:00 - 15:30</div>
                                <div class="hoursopen">Środa 9:00 - 15:30</div>
                            </div>
                            <div class="col-6 hours justify-content-center">
                                <div class="hoursopen">Czwartek 9:00 - 15:30</div>
                                <div class="hoursopen">Piątek 9:00 - 15:30</div>
                                <div class="hoursopen">Sobota 9:00 - 15:30</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 portals-columns column-middle">
                       <p>Bądź na bieżąco</p>
                        <ul>
                            <li>
                                <a href="https://www.facebook.com/domincitattoo">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                    <svg width="35" height="35" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f" class="icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path></svg>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/domincitattoo/">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                    <svg width="35" height="35" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" class="icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"></path></svg>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/user/PabloDominci">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                    <svg width="35" height="35" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="youtube" class="icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"></path></svg>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-4 portals-columns"><div class="col-12" id="polstr">Polecane przez nas strony</div>
                        <svg class="col-12" width="400" height="90" version="1.1" id="Warstwa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 260.7 87.3" style="enable-background:new 0 0 260.7 87.3;" xml:space="preserve">
                            <style type="text/css">
                                .st0{fill:#E4091E;}
                            </style>
                ...
                <hr id="line">
                <div class="col-12" id="rights"><p>© 2016 - 2020 Copyright Dominci Tatoo. Wszelkie prawa zastrzeżone.</p></div>
            </footer>
        </article>
    ...
    <script type="text/javascript">
        ...
        function validate(element) {
            const ErrorStyle = "inset 0px -6px 9px -8px rgb(250, 0, 0)";
        ...
        const nameField2 = document.querySelector("#email");
        const nameField3 = document.querySelector("#subject");
        const nameField4 = document.querySelector("#message");
        
        nameField.addEventListener('input', function(event){ validate(event.target)});
        nameField2.addEventListener('input', function(event){ validate(event.target)});
        nameField3.addEventListener('input', function(event){ validate(event.target)});
        nameField4.addEventListener('input', function(event){ validate(event.target)});
    ...
    <script src="https://use.fontawesome.com/66efddd997.js"></script>
    <script type="text/javascript">
